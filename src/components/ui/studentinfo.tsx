...
export default function StudentInfo() {
    ...
    return (
        <div className="w-full flex flex-col gap-[10px] text-[#32323d]">
            <h1 className="text-xl font-bold mb-2 text-center">THÔNG TIN SINH VIÊN</h1>
            <div className='border-b-4 border-[#CD1628] py-[10px]'>
