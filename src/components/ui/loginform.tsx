    ...
    return (
        <div className='relative z-10 flex items-center justify-center h-screen'>
            <div className='bg-[#AA1D2B] bg-opacity-90 rounded-[15px] p-8 shadow-lg w-full max-w-md'>
                <h1 className="text-2xl [font-family:'Poppin_Bold'] text-center mb-6 text-white">Đăng nhập</h1>
                <form onSubmit={handleLogin} className="space-y-4 flex flex-col items-center">
                    ...
                    <button type="submit" disabled={loading} className="w-full bg-white text-[#AA1D2B] [font-family:'Poppin_Bold'] py-2 rounded-[8px] cursor-pointer">
