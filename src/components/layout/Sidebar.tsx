...
export default function Sidebar() {
    ...
    const isActive = (path: string) =>
        pathname === path
            ? 'bg-[rgba(0,0,0,0.05)] border-l-[#CD1628]'
            : 'border-l-transparent hover:bg-[rgba(0,0,0,0.05)]';
            ...
            <div className="flex flex-col h-full pt-[70px] overflow-hidden">
                ...
                <div className="h-full overflow-hidden">
                    <nav className="w-full relative mb-4">
                        <ul>
                            <li className={`text-[#32323d] border-l-[3px] hover:bg-[rgba(0,0,0,0.05)] cursor-pointer ${isActive('/student-info')}`}>
                            ...
                            <li className={`text-[#32323d] border-l-[3px] hover:bg-[rgba(0,0,0,0.05)] cursor-pointer ${isActive('/student-class')}`}>
                    ...
                    <nav className="w-full relative mb-4 overflow-hidden h-full">
                        <ul>
                            ...
                            <li className={`text-[#32323d] border-l-[3px] hover:bg-[rgba(0,0,0,0.05)] cursor-pointer ${isActive('/aggregate-score')}`}>
                            ...
                            <li className={`text-[#32323d] border-l-[3px] hover:bg-[rgba(0,0,0,0.05)] cursor-pointer ${isActive('/toeic-score')}`}>
                    ...
                    <nav className="w-full relative mb-4 overflow-hidden h-full">
                        <ul>
                            <li className={`text-[#32323d] border-l-[3px] hover:bg-[rgba(0,0,0,0.05)] cursor-pointer ${isActive('/tuition')}`}>
                                <Link href="/tuition" title="Thông tin công nợ học phí" className="flex items-center gap-[10px] text-sm leading-5 font-medium py-[12px] px-[21px]">
