...
export async function scrapeProgram(client: ReturnType<typeof wrapper>) {
    const response = await client.get(PROGRAM_URL, { responseType: 'arraybuffer' });
...
export async function POST(req: NextRequest) {
    try {
        ...
        const data = await scrapeProgram(client);
