...
export async function scrapeToeic(client: ReturnType<typeof wrapper>) {
    const response = await client.get(TOEIC_URL, { responseType: 'arraybuffer' });
...
export async function POST(req: NextRequest) {
    try {
        ...
        const data = await scrapeToeic(client);
