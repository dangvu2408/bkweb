...
export async function scrapeTuition(client: ReturnType<typeof wrapper>) {
    ...
    const ghiChuSoTienHP = note.find('li span').eq(1).text()
        .replace('tại đây', 'tại https://ctt.hust.edu.vn/DisplayWeb/DisplayBaiViet?baiviet=43430');
...
export async function POST(req: NextRequest) {
    try {
        ...
        const data = await scrapeTuition(client);
